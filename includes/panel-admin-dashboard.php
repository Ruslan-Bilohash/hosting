...
function hs_panel_admin_dashboard_block(array $t, string $lang): string
{
    ...
    return '<section class="hs-admin-dash-panel">'
        ...
        . '<a href="' . hs_h(hs_admin_url()) . '" class="hs-btn hs-btn-primary hp-dash-btn-sm"><i class="fa-solid fa-gauge-high"></i> ' . hs_h($t['admin_title'] ?? 'Admin') . '</a>'
        ...
        . '<a href="' . hs_h(hs_admin_url('mysql.php')) . '" class="hs-btn hs-btn-ghost hp-dash-btn-sm"><i class="fa-solid fa-database"></i> ' . hs_h($t['admin_mysql_title'] ?? 'MySQL') . '</a>'
        . '<a href="' . hs_h(hs_url(hs_panel_path('clients.php'))) . '" class="hs-btn hs-btn-ghost hp-dash-btn-sm"><i class="fa-solid fa-user-gear"></i> ' . hs_h($t['nav_clients'] ?? '') . '</a>'
